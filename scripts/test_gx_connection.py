...
batch_request = RuntimeBatchRequest(
    ...
    data_asset_name="indicators",  # nome definido pelo usuário para o asset de dados
    runtime_parameters={"path": os.path.join(data_dir, "indicators.csv")},
    batch_identifiers={"default_identifier_name": "default_identifier"},
)

# Cria a suíte de expectativas
suite_name = "indicators_suite"
try:
...
validator.expect_column_values_to_be_unique("IndicatorCode")
