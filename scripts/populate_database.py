...
def get_or_create_id(cursor: sqlite3.Cursor, table: str, id_column: str, code_column: str, code_value: Any) -> int:
    ...
    Args:
        ...
        code_value (Any): Valor do código a ser buscado ou criado.
